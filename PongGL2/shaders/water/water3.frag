...
void main()
{
	vec3 norm1 = normalize(texture2D(normalMap1, gl_TexCoord[0].st + vec2(time/20.0, 0.0)).xyz * 2.0 - 1.0);
	vec3 norm2 = normalize(texture2D(normalMap2, gl_TexCoord[0].st + vec2(time/20.0, time/20.0)).xyz * 2.0 - 1.0);
